        ...
        NavigationStack {
            ScrollView {
                VStack {
                    ...
                    pickerField(title: "What did you lose?", selection: $selectedItemType, options: itemTypes)
                    pickerField(title: "Where did you lose it?", selection: $selectedLocation, options: locations)
                ...
                .sheet(isPresented: $showingImagePicker) {
                    ImagePickerLost(image: $selectedImage, isCamera: $isCamera) // Use ImagePicker when adding images
                }.alert(isPresented: $showAlert) {
                    Alert(
                        title: Text("Success"),
                        message: Text(message),
...
struct ImagePickerLost: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
        var parent: ImagePickerLost
        
        init(_ parent: ImagePickerLost) {
            self.parent = parent
        }
...
struct ViewFoundItemsLost_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            ViewLostItems(navigateToUserView: .constant(false)) // Logged Out State
                .previewDisplayName("Report Lost Item")
        }
    }
}
